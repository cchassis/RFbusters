...
- The technical details of the transmitter are as follows:
   ...
   - The baseband transmitter signal will be a pseudo-noise (PN) sequence generated by a linear feedback shift-register at rate up to 1 Mchips/s. The shift register configuration will be provided for finalist teams, with at least a sequence of 210-1 chips being used.
