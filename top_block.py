...
# Title: Top Block
# Generated: Fri May  4 15:11:10 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.digital_pn_correlator_cc_0, 0))    
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.qtgui_sink_x_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.blocks_interleaved_char_to_complex_0, 0))    
        self.connect((self.digital_pn_correlator_cc_0, 0), (self.qtgui_sink_x_0_0, 0))    
